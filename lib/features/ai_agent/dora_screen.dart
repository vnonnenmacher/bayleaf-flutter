...
class _DoraScreenState extends State<DoraScreen> {
  ...
  Future<void> _loadMessages() async {
    ...
    // If relative or professional, change messages
            ...
            ListTile(
              ...
              onTap: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                    content: Text("Selecionar documento...")));
              },
            ),
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context);
                ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                    content: Text("Selecionar da galeria...")));
              },
            ),
          ],
        ),
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                                color: e.color.withOpacity(0.25), width: 1),
                          ),
                          child: Column(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.only(
                                ...
                                bottomLeft:
                                    Radius.circular(isDora ? 4 : 18),
                                bottomRight:
                                    Radius.circular(isDora ? 18 : 4),
                              ),
                            ),
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
